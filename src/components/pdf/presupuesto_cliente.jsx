      ...
      >
        ...
        <View>
          <View style={{ marginTop: "10" }}>
            ...
            {cabinets &&
              cabinets.regletas.map((item, index) => (
                <View
                  key={index}
                  style={{
                    display: "flex",
            ...
            {cabinets &&
              cabinets.costados.map((item, index) => (
                <View
                  key={index}
                  style={{
                    display: "flex",
            ...
            {cabinets &&
              cabinets.complementos.map((item, index) => (
                <View
                  key={index}
                  style={{
                    display: "flex",
            ...
            {cabinets &&
              cabinets.accesorios.map((item, index) => (
                <View
                  key={index}
                  style={{
                    display: "flex",
          ...
          {cabinets &&
            cabinets.decorativos.map((item, index) => (
              <View
                key={index}
                style={{
                  display: "flex",
...
export default React.memo(Presupuesto_Cliente);
